...
try {
	...
	$show_playwright_name=$_POST["show_playwright_name"];

		//SQL statement to insert into the database
	$sql = "INSERT INTO show_playwright_info (show_playwright_ID, show_playwright_name)
	VALUES ('', '$show_playwright_name')";
	if ($conn->query($sql)) {
