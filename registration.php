...
/*SELECT COUNTRY*/
$country_select = 'SELECT * FROM country';
$statement = $conn->prepare($country_select);
$statement->execute();
$select_country = $statement->fetchAll();
$statement->closeCursor();

/*SELECT GENDER*/
$gender_select = 'SELECT * FROM gender';
$statement = $conn->prepare($gender_select);
$statement->execute();
$select_gender = $statement->fetchAll();
$statement->closeCursor();
?>
<html>
	<head>
...
<body>
	...
	<main class="mt-5 pt-5" role="main">
		<div class="container">
			<p class="h2 paragraphTitle">Registration Page</p>
			<form action="usersignup.php" method="post" id="registrationForm">
				<div class="row">
					<div class="col">
				...
				<div class="row">
					...
					<div class="col">
						<?php foreach($select_gender as $selectionGender): ?>
							<input type="radio" name="gender" id="gender" value="<?php echo $selectionGender['gender_ID']?>"> <?php echo $selectionGender['gender_name']?><br>
						<?php endforeach; ?>
					</div>
				</div>
				<div class="row">
				...
				<p class="h2 paragraphTitle">Additional Information</p>
					<p class="small">Those information are not required, and you will still be able to add them later on going into your profile account.</p>
					<p>Check as some of those are not into the database!</p>
				<div class="row">
				...
				<div class="row">
					...
					<div class="col">
						<select>
							<?php foreach ($select_country as $selectionCountry): ?>
								<option value="<?php echo $selectionCountry['country_ID']; ?>" id="country_ID" name="country_ID"><?php echo $selectionCountry['country_name']; ?></option>
							<?php endforeach; ?>
						</select>
					</div>
				</div>
				<div class="row">
					...
					<div class="col">
						<select>
							<?php foreach ($select_country as $selectionCountry): ?>
								<option value="<?php echo $selectionCountry['country_ID']; ?>"><?php echo $selectionCountry['country_name']; ?></option>
							<?php endforeach; ?>
						</select>
					</div>
				</div>
				<div class="row">
					...
					<div class="col">
						<input type="text" name="userHeight" id="userHeight">
					</div>
				</div>
				<div class="row">
					<div class="col">
					...
					<div class="col">
						<textarea row="4" col="50" type="text" name="userBiography" id="userBiography"></textarea>
					</div>
				</div>
				<div class="row">
					<div class="col"></div>
