...
$queryComposerInfo = 'SELECT * FROM show_composer_info ORDER BY show_composer_name';
$statement1 = $conn->prepare($queryComposerInfo);
$statement1->execute();
$composerList = $statement1->fetchAll();
$statement->closeCursor();
?>
<html>
	<head>
	...
	<main class="mt-5 pt-5" role="main">
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="container">
						<form action="connectComposer.php" method="post" id="registrationForm">
							...
							<p class="h2 paragraphTitle">Composer</p>
							<div class="row">
								<select name="composer_ID">
									<?php foreach ($composerList as $listOfComposer): ?>
										<option value="<?php echo $listOfComposer['show_composer_ID']; ?>"><?php echo $listOfComposer['show_composer_name']; ?></option>
									<?php endforeach ; ?>
								</select>
							</div>
				...
				<div class="col">
					<div class="container">
						<form action="addComposerInfoToDatabase.php" method="post" id="registrationForm">
							<p class="h2 paragraphTitle">Add Composer if not present</p>
							<p class="h2 paragraphTitle">Comoser</p>
							<div class="row">
								<label>Composer Name</label>
								<input type="text" name="show_composer_name" id="show_composer_name">
							</div>
							<input type="submit" value="register">
						</form>
					</div>
